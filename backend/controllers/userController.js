...
exports.signupUser = catchAsync(async (req, res, next) => {
    try {
        ...
        const newUser = await User.create({
            ...
            username,
            password,
            avatar: req.file.location // Assuming you're storing the avatar URL in req.file.location
        });

        // You should implement a function to send a response or set a session/JWT token here
        ...
        next(error); // Assuming you have an error-handling middleware
    }
});
...
exports.loginUser = catchAsync(async (req, res, next) => {
    ...
    // Find the user by email or username and include the password field for comparison
    ...
    // You should implement a function to set a session or JWT token here
    sendCookie(user, res);
    ...
    res.status(200).json({
        ...
        data: user, // You can include user data here if needed
    });
});
